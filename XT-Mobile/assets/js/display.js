function displayProduct(arrayProduct) {
    ...
    if (document.getElementById("user").innerHTML === 'Admin') {
        for (let i = 0; i < arrayProduct.length; i++) {
            ...
            dataHtml += `<div class="product-cart" id="cart-${arrayProduct[i].getBrand()}-${i}"><button onclick="addToCart(${i},'${arrayProduct[i].getBrand()}')"><i class="fa-solid fa-cart-shopping"></i></button></div>`
